...
export default function App() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['home', 'products', 'publications', 'timeline', 'team', 'contact'];
  ...
  return (
    <div className="bg-white text-gray-900">
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white bg-opacity-90 backdrop-blur-md border-b border-gray-200 transition-all duration-300">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <ul className="hidden md:flex space-x-8">
            {['Home', 'Products', 'Publications', 'Team', 'About', 'Contact'].map((item) => (
              <li key={item}>
                <a 
                  href={`#${item.toLowerCase().replace(' ', '')}`}
                  className={`hover:text-primary transition-colors ${activeSection === item.toLowerCase().replace(' ', '') ? 'text-primary' : ''}`}
                >
                  {item}
                </a>
              </li>
      ...
      <section id="home" className="min-h-screen pt-24 flex items-center relative overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <img src="https://placehold.co/1920x1080?text=iPhase+Automation+Solutions" alt="Hero Background" className="w-full h-full object-cover" />
        </div>
        ...
        <div className="container mx-auto px-4 z-10">
          <div className="max-w-2xl">
            ...
            <p className="text-xl mb-8 text-gray-700 animate-slideUp delay-200">
            ...
            <div className="flex flex-wrap gap-4 animate-slideUp delay-300">
              ...
              <a href="#contact" className="px-8 py-3 border border-primary text-primary rounded-full hover:bg-lightBg transition-colors">
                Contact Us
              </a>
            </div>
          </div>
      ...
      <button 
        ...
        className="fixed bottom-8 right-8 p-3 bg-primary text-white rounded-full shadow-lg hover:bg-secondary transition-colors"
      >
